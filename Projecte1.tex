...
\midrule
nom & \texttt{string} \\
editor & \texttt{string} (\texttt{\_id} de l'editorial) \\
gènere & \texttt{string} \\
idioma & \texttt{string} \\
any d'inici & \texttt{int} \\
any de finalització & \texttt{int} \\
acabada & \texttt{bool} \\
publicacions & llista de documents de publicacions \\
\midrule
\textbf{Publicació} & \\
\midrule
ISBN & \texttt{string} \\
...
artistes & \texttt{list} of \texttt{subdocuments}: \texttt{\_id} (\texttt{string}) i contribuci\'o (\texttt{string}) de l'artista\\
\midrule
\textbf{Artista} & \\
\midrule
